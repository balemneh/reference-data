...
public class ChangeRequestWorkflowIntegrationTest {
    ...
    void testCompleteCreateWorkflow() throws Exception {
        ...
        Optional<Country> createdCountry = countryRepository.findByCountryCodeAndSystemCode(
    ...
    void testCompleteUpdateWorkflow() throws Exception {
        ...
        Optional<Country> updatedCountry = countryRepository.findByCountryCodeAndSystemCode(
    ...
    void testRejectionWorkflow() throws Exception {
        ...
        Optional<Country> shouldNotExist = countryRepository.findByCountryCodeAndSystemCode(
                testCountryDto.getCountryCode(), testCodeSystem.getCode());
    ...
    void testScheduledImplementationWorkflow() throws Exception {
        ...
        // Note: effectiveDate field not yet implemented in ChangeRequest entity

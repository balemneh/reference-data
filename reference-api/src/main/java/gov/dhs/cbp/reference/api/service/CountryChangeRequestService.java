...
public class CountryChangeRequestService {
    ...
    private static final Logger log = LoggerFactory.getLogger(CountryChangeRequestService.class);
    ...
    public ChangeRequest createChangeRequest(CountryDto countryDto, String operation, String userId, String reason) {
        log.info("Creating change request for country: {}, operation: {}, user: {}", countryDto, operation, userId);
        validateChangeRequestData(countryDto, operation, userId);
        log.info("Change request data validated");
        ...
        log.info("Change request setup complete");
        ChangeRequest savedChangeRequest = changeRequestRepository.save(changeRequest);
        log.info("Change request saved: {}", savedChangeRequest);
    ...
    public PagedResponse<ChangeRequest> getChangeRequestHistory(UUID entityId, Pageable pageable) {
        ...
        Page<ChangeRequest> page = changeRequestRepository.findByFilters(
            null, null, DATA_TYPE, null, fromDate, pageable, null
        );

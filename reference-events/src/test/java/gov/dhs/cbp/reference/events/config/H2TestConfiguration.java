...
/**
 * Shared H2 test configuration for reference-events module.
...
public class H2TestConfiguration {
    ...
    public DataSource h2TestDataSource() {
        ...
        dataSource.setUrl("jdbc:h2:mem:eventsTestDb;MODE=PostgreSQL;DATABASE_TO_LOWER=TRUE;DEFAULT_NULL_ORDERING=HIGH;CASE_INSENSITIVE_IDENTIFIERS=TRUE;INIT=CREATE SCHEMA IF NOT EXISTS reference_data");
